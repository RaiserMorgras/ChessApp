...
public interface IChessUI {
     ...
     *                     not used.
     */
    void turnStartSequence(int turnCount, GameStateID currentPlayer, String extraMessage);
     ...
     * @param gameStateID an enum representing the result of the game
     */
    void gameEndSequence(GameStateID gameStateID);
}
